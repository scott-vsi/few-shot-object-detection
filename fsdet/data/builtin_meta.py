...
KALGOORLIE_CATEGORIES = [
    {"color": [5, 93, 40], "isthing": 1, "id": 1, "name": "Engineering Vehicle"},
    {"color": [211, 221, 20], "isthing": 1, "id": 2, "name": "Engineering Vehicle:Backhoe"},
    {"color": [245, 81, 155], "isthing": 1, "id": 3, "name": "Engineering Vehicle:Blasthole Drill"},
    {"color": [39, 54, 109], "isthing": 1, "id": 4, "name": "Engineering Vehicle:Cement Mixer"},
    {"color": [167, 62, 178], "isthing": 1, "id": 5, "name": "Engineering Vehicle:Crane Truck"},
    {"color": [130, 5, 104], "isthing": 1, "id": 6, "name": "Engineering Vehicle:Drill Jumbo"},
    {"color": [90, 177, 45], "isthing": 1, "id": 7, "name": "Engineering Vehicle:Dump Truck"},
    {"color": [131, 237, 189], "isthing": 1, "id": 8, "name": "Engineering Vehicle:Face Shovel"},
    {"color": [68, 147, 31], "isthing": 1, "id": 9, "name": "Engineering Vehicle:Farm Tractor"},
    {"color": [145, 242, 157], "isthing": 1, "id": 10, "name": "Engineering Vehicle:Ground Grader"},
    {"color": [29, 64, 102], "isthing": 1, "id": 11, "name": "Engineering Vehicle:Large Cherry Picker"},
    {"color": [222, 31, 3], "isthing": 1, "id": 12, "name": "Engineering Vehicle:Large Dozer"},
    {"color": [207, 192, 160], "isthing": 1, "id": 13, "name": "Engineering Vehicle:Large Excavator"},
    {"color": [233, 71, 16], "isthing": 1, "id": 14, "name": "Engineering Vehicle:Large Haul Truck"},
    {"color": [177, 179, 146], "isthing": 1, "id": 15, "name": "Engineering Vehicle:Large Loader"},
    {"color": [176, 177, 128], "isthing": 1, "id": 16, "name": "Engineering Vehicle:Long Reach Drill"},
    {"color": [28, 84, 222], "isthing": 1, "id": 17, "name": "Engineering Vehicle:Low Haul Truck"},
    {"color": [230, 182, 146], "isthing": 1, "id": 18, "name": "Engineering Vehicle:Mobile Crane"},
    {"color": [145, 17, 58], "isthing": 1, "id": 19, "name": "Engineering Vehicle:Rope Shovel"},
    {"color": [93, 76, 58], "isthing": 1, "id": 20, "name": "Engineering Vehicle:Small Cherry Picker"},
    {"color": [254, 29, 142], "isthing": 1, "id": 21, "name": "Engineering Vehicle:Small Dozer"},
    {"color": [173, 163, 39], "isthing": 1, "id": 22, "name": "Engineering Vehicle:Small Excavator"},
    {"color": [232, 174, 67], "isthing": 1, "id": 23, "name": "Engineering Vehicle:Small Haul Truck"},
    {"color": [197, 89, 29], "isthing": 1, "id": 24, "name": "Engineering Vehicle:Small Loader"},
    {"color": [146, 116, 165], "isthing": 1, "id": 25, "name": "Engineering Vehicle:Tower Crane"},
    {"color": [105, 83, 143], "isthing": 1, "id": 26, "name": "Engineering Vehicle:Scraper"},
    {"color": [105, 187, 183], "isthing": 1, "id": 27, "name": "Engineering Vehicle:Water Truck"},
    {"color": [5, 93, 40], "isthing": 1, "id": 28, "name": "Aircraft"},
    {"color": [211, 221, 20], "isthing": 1, "id": 29, "name": "Aircraft:Passenger/Cargo Plane"},
    {"color": [245, 81, 155], "isthing": 1, "id": 30, "name": "Aircraft:Small Aircraft"},
    {"color": [39, 54, 109], "isthing": 1, "id": 31, "name": "Aircraft:Helicopter"},
    {"color": [167, 62, 178], "isthing": 1, "id": 32, "name": "Maritime Vessel"},
    {"color": [130, 5, 104], "isthing": 1, "id": 33, "name": "Passenger Vehicle"},
    {"color": [90, 177, 45], "isthing": 1, "id": 34, "name": "Passenger Vehicle:Bus"},
    {"color": [131, 237, 189], "isthing": 1, "id": 35, "name": "Passenger Vehicle:Motorcycle"},
    {"color": [68, 147, 31], "isthing": 1, "id": 36, "name": "Passenger Vehicle:Pickup Truck"},
    {"color": [145, 242, 157], "isthing": 1, "id": 37, "name": "Passenger Vehicle:Recreational Vehicle"},
    {"color": [29, 64, 102], "isthing": 1, "id": 38, "name": "Passenger Vehicle:Sedan"},
    {"color": [222, 31, 3], "isthing": 1, "id": 39, "name": "Passenger Vehicle:SUV"},
    {"color": [207, 192, 160], "isthing": 1, "id": 40, "name": "Passenger Vehicle:Van"},
    {"color": [233, 71, 16], "isthing": 1, "id": 41, "name": "Railway Vehicle"},
    {"color": [177, 179, 146], "isthing": 1, "id": 42, "name": "Truck"},
    {"color": [176, 177, 128], "isthing": 1, "id": 43, "name": "Truck:Box Truck"},
    {"color": [28, 84, 222], "isthing": 1, "id": 44, "name": "Truck:Car Carrier"},
    {"color": [230, 182, 146], "isthing": 1, "id": 45, "name": "Truck:Fire Truck"},
    {"color": [145, 17, 58], "isthing": 1, "id": 46, "name": "Truck:Flatbed Truck"},
    {"color": [93, 76, 58], "isthing": 1, "id": 47, "name": "Truck:Small Multipurpose"},
    {"color": [254, 29, 142], "isthing": 1, "id": 48, "name": "Truck:Step Van"},
    {"color": [173, 163, 39], "isthing": 1, "id": 49, "name": "Truck:Tanker Truck"},
    {"color": [232, 174, 67], "isthing": 1, "id": 50, "name": "Truck:Tow Truck"},
    {"color": [197, 89, 29], "isthing": 1, "id": 51, "name": "Truck:Trailer"},
    {"color": [146, 116, 165], "isthing": 1, "id": 52, "name": "Truck:Truck Tractor w/Box Trailer"},
    {"color": [105, 83, 143], "isthing": 1, "id": 53, "name": "Truck:Truck Tractor w/Flatbed Trailer"},
    {"color": [105, 187, 183], "isthing": 1, "id": 54, "name": "Truck:Truck Tractor w/Liquid Tank"},
    {"color": [105, 116, 183], "isthing": 1, "id": 55, "name": "Truck:Truck Tractor"},
    {"color": [105, 187, 116], "isthing": 1, "id": 56, "name": "Truck:Utility Truck"},
]
...
def _get_builtin_metadata(dataset_name):
    if dataset_name == "coco":
        ...
        return _get_coco_fewshot_instances_meta(categories=KALGOORLIE_CATEGORIES,
                novel_categories=KALGOORLIE_NOVEL_CATEGORIES, nthings=56)
