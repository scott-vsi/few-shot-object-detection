...
KALGOORLIE_CATEGORIES = [
    ...
    {"color": [248, 89, 131], "isthing": 1, "id": 6, "name": "Engineering Vehicle:Drill Jumbo"},
    {"color": [88, 50, 22], "isthing": 1, "id": 7, "name": "Engineering Vehicle:Dump Truck"},
    {"color": [159, 66, 166], "isthing": 1, "id": 10, "name": "Engineering Vehicle:Ground Grader"},
    {"color": [100, 244, 58], "isthing": 1, "id": 11, "name": "Engineering Vehicle:Large Cherry Picker"},
    {"color": [20, 42, 85], "isthing": 1, "id": 12, "name": "Engineering Vehicle:Large Dozer"},
    {"color": [90, 215, 67], "isthing": 1, "id": 13, "name": "Engineering Vehicle:Large Excavator"},
    ...
    {"color": [252, 219, 116], "isthing": 1, "id": 20, "name": "Engineering Vehicle:Small Cherry Picker"},
    {"color": [198, 52, 123], "isthing": 1, "id": 21, "name": "Engineering Vehicle:Small Dozer"},
    {"color": [21, 186, 41], "isthing": 1, "id": 22, "name": "Engineering Vehicle:Small Excavator"},
    {"color": [48, 0, 133], "isthing": 1, "id": 23, "name": "Engineering Vehicle:Small Haul Truck"},
    {"color": [57, 54, 138], "isthing": 1, "id": 24, "name": "Engineering Vehicle:Small Loader"},
    {"color": [164, 30, 148], "isthing": 1, "id": 27, "name": "Engineering Vehicle:Water Truck"},
    {"color": [80, 55, 222], "isthing": 1, "id": 34, "name": "Passenger Vehicle:Bus"},
    {"color": [109, 45, 165], "isthing": 1, "id": 35, "name": "Passenger Vehicle:Motorcycle"},
    {"color": [50, 228, 1], "isthing": 1, "id": 36, "name": "Passenger Vehicle:Pickup Truck"},
    {"color": [220, 65, 187], "isthing": 1, "id": 38, "name": "Passenger Vehicle:Sedan"},
    {"color": [123, 48, 94], "isthing": 1, "id": 39, "name": "Passenger Vehicle:SUV"},
    {"color": [121, 61, 23], "isthing": 1, "id": 40, "name": "Passenger Vehicle:Van"},
    {"color": [151, 190, 8], "isthing": 1, "id": 43, "name": "Truck:Box Truck"},
    {"color": [16, 125, 122], "isthing": 1, "id": 46, "name": "Truck:Flatbed Truck"},
    {"color": [196, 123, 14], "isthing": 1, "id": 52, "name": "Truck:Truck Tractor with Box Trailer"},
    {"color": [119, 135, 18], "isthing": 1, "id": 53, "name": "Truck:Truck Tractor with Flatbed Trailer"},
    {"color": [214, 190, 111], "isthing": 1, "id": 56, "name": "Truck:Utility Truck"},
]
